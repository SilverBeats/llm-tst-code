...
| IMDb         | Positive(1) ↔ Negative(0)               | train: 366,466<br/>test: 2,000                 |                                                              | \[[Code](https://github.com/lissomx/DGST/)\]  [Paper[^5]]    |
...
| Political    | Republican(0) ↔ Democratic(1)           | train: 537,922<br/>dev: 4,000<br/>test: 56,000 |                                                              | [Paper[^6][^7]]<br/>[[Code](https://github.com/shrimai/Style-Transfer-Through-Back-Translation)]<br/>[[Link](http://tts.speech.cs.cmu.edu/style_models/political_data.tar)] |
| Gender       | Male(0) ↔ Female(1)                     | train: 200,000<br/>dev: 2,000<br/>test: 4,000  |                                                              | [Paper[^6][^8]<br/>[[Code](https://github.com/EwoeT/MLM-style-transfer/)]<br/>[[Link](http://tts.speech.cs.cmu.edu/style_models/gender_data.tar)] |
...
| [Paper[^5]]<br/>[[Code](https://github.com/lissomx/DGST/)]   | IMDb         | Acc: FastText (acc=95% on test)<br/>s-BLEU: corpus_bleu and sentence_bleu |
...
1. Yelp: Do not use ppl and gm.  We received unsatisfactory results (the perplexity was close to 1000) after implementing the KenLM model using the original code. Since PPL was not used, the GM could not adopt it either.
2. IMDb:  The paper[^5]'s code repository calculates `corpus_bleu` and `sentence_bleu`, but doesn't specify which BLEU are derived from. We use `corpus_bleu` in our paper.
3. The accuracy results for the *imagecaption*, *gender*, and *political* datasets differ from those reported in the original paper, which claimed 80%, 82%, and 92%, respectively. However, the original paper did not provide the relevant Fasttext training parameters such as the number of epochs, learning rate, dimension, etc. Hence, replicating the same results as reported in the original paper is not an easy task.
...
The possible options for the dataset are *yelp*, *amazon*, *imdb*, *imagecaption*, *paper*, *political*, and *gender*.
...
[^5]: Xiao Li, Guanyi Chen, Chenghua Lin, and Ruizhe Li. 2020. [DGST: a Dual-Generator Network for Text Style Transfer](https://aclanthology.org/2020.emnlp-main.578). In *Proceedings of the 2020 Conference on Empirical Methods in Natural Language Processing (EMNLP)*, pages 7131–7136, Online. Association for Computational Linguistics.

[^6]:Shrimai Prabhumoye, Yulia Tsvetkov, Ruslan Salakhutdinov, and Alan W Black. 2018. [Style Transfer Through Back-Translation](https://aclanthology.org/P18-1080). In *Proceedings of the 56th Annual Meeting of the Association for Computational Linguistics (Volume 1: Long Papers)*, pages 866–876, Melbourne, Australia. Association for Computational Linguistics.

[^7]:Rob Voigt, David Jurgens, Vinodkumar Prabhakaran, Dan Jurafsky, and Yulia Tsvetkov. 2018. [RtGender: A Corpus for Studying Differential Responses to Gender](https://aclanthology.org/L18-1445). In *Proceedings of the Eleventh International Conference on Language Resources and Evaluation (LREC 2018)*, Miyazaki, Japan. European Language Resources Association (ELRA).
[^8]: Sravana Reddy and Kevin Knight. 2016. [Obfuscating Gender in Social Media Writing](https://aclanthology.org/W16-5603). In *Proceedings of the First Workshop on NLP and Computational Social Science*, pages 17–26, Austin, Texas. Association for Computational Linguistics.
